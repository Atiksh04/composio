...
def check_code_quality(data):
    ...
    if payload['action'] == 'open':
        ...
        task = f"""For this PR URL: {PR_URL}. Check all the file changes that are made and these changes used comply these rules: 
        any print statements should not be present, comments should be added for each function added, unused variables shouldn't be
        present and length of any line shouldn't be more than 250 characters to ensure readibility. Mention all the rules these
